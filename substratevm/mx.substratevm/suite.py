...
suite = {
    ...
    "libraries": {
        "RENAISSANCE_HARNESS_v0.9": {
            "urls": [
                "https://lafo.ssw.uni-linz.ac.at/pub/graal-external-deps/renaissance/renaissance-harness_v0.9.0.tar.gz"],
            "sha1": "0bef46df4699d896034005d6f3f0422a7075482b",
            "packedResource": True,
        },
        "RENAISSANCE_HARNESS_v0.10": {
            "urls": [
                "https://lafo.ssw.uni-linz.ac.at/pub/graal-external-deps/renaissance/renaissance-harness_v0.10.0.tar.gz"],
            "sha1": "842e60f56d9871a1fa5700dcc446acbd041e875b",
            "packedResource": True,
        },
        "RENAISSANCE_HARNESS_v0.11": {
            "urls": [
                "https://lafo.ssw.uni-linz.ac.at/pub/graal-external-deps/renaissance/renaissance-harness_v0.11.0.tar.gz"],
    ...
    "projects": {
        ...
        "com.oracle.svm.native.libchelper": {
            ...
            "os_arch": {
                ...
                "<others>": {
                    "<others>": {
                        "cflags": ["-g", "-gdwarf-4", "-fPIC", "-O2", "-D_LITTLE_ENDIAN", "-ffunction-sections",
        ...
        "com.oracle.svm.native.darwin": {
            ...
            "os_arch": {
                "darwin": {
                    "<others>": {
                        "cflags": ["-ObjC", "-fPIC", "-O1", "-D_LITTLE_ENDIAN", "-ffunction-sections",
                                   "-fdata-sections", "-fvisibility=hidden", "-D_FORTIFY_SOURCE=0"],
                    },
                },
                "<others>": {
        ...
        "com.oracle.svm.native.jvm.posix": {
            ...
            "os_arch": {
                ...
                "linux": {
                    "<others>": {
                        "cflags": ["-g", "-gdwarf-4", "-fPIC", "-O2", "-ffunction-sections", "-fdata-sections",
                                   "-fvisibility=hidden", "-D_FORTIFY_SOURCE=0", "-D_GNU_SOURCE"],
                    },
                },
                "<others>": {
                    "<others>": {
