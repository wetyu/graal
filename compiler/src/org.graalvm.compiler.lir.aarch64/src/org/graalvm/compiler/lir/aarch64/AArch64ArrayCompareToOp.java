...
public final class AArch64ArrayCompareToOp extends AArch64LIRInstruction {
    ...
    private void emitSIMDCode(AArch64MacroAssembler masm, Label stringsEqualUptoLength) {
        ...
        if (isSameEncoding) {
            ...
            masm.neon.ushll2VVI(AArch64ASIMDAssembler.ElementSize.Byte, array1HighV, array1LowV, 0);
            masm.neon.ushllVVI(AArch64ASIMDAssembler.ElementSize.Byte, array1LowV, array1LowV, 0);
        }
        ...
        masm.neon.eorVVV(AArch64ASIMDAssembler.ASIMDSize.FullReg, array1LowV, array1LowV, array2LowV);
        masm.neon.eorVVV(AArch64ASIMDAssembler.ASIMDSize.FullReg, array1HighV, array1HighV, array2HighV);
        masm.neon.orrVVV(AArch64ASIMDAssembler.ASIMDSize.FullReg, tmpRegV1, array1LowV, array1HighV);
        masm.neon.addvSV(AArch64ASIMDAssembler.ASIMDSize.FullReg, eSize, tmpRegV1, tmpRegV1);
        masm.fcmpZero(64, tmpRegV1);
        masm.branchConditionally(ConditionFlag.NE, misMatchInChunk);
        ...
        masm.neon.cmeqZeroVV(AArch64ASIMDAssembler.ASIMDSize.FullReg, eSize, array1LowV, array1LowV);
        masm.neon.cmeqZeroVV(AArch64ASIMDAssembler.ASIMDSize.FullReg, eSize, array1HighV, array1HighV);
